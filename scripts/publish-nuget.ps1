# Seed.Net NuGet Package Publisher
# This script builds and publishes the Seed.Net package to NuGet.org
...
$ProjectPath = Join-Path $RootDir "src\Seed128\seed128.csproj"
$Configuration = "Release"
$OutputDirectory = Join-Path $RootDir "src\Seed128\bin\Release"
...
Write-Host ""
Write-Info "========================================="
Write-Info "  Seed.Net NuGet Package Publisher"
Write-Info "========================================="
Write-Host ""

# API key handling (skip requirement in DryRun)
if (-not $DryRun) {
    ...
    Write-Warning "Dry run mode: skipping API key requirement and push step"
}
...
if (-not $SkipTests) {
    ...
    $TestPath = Join-Path $RootDir "tests\Seed128.Test\Seed128.Test.csproj"
...
if ($DryRun) {
    ...
    Write-Success "========================================="
    Write-Host ""
    Write-Info "Package URL: https://www.nuget.org/packages/Seed.Net.Seed128/"
